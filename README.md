...
25. [Shieldly](https://www.shieldly.io) - AI-Powered security analysis for AWS IAM policies, CloudFormation templates, and costs. Detects over-privilege, privilege escalation paths, wildcard policy risks, and trust policy misconfigurations. Free demo (no signup). Ships as web app, CLI, VS Code extension, and GitHub Action.
