...
25. [AWS Security Audit Scripts](https://github.com/TrazTech-Inc/cloud-security-audit-scripts/tree/main/aws) - Python scripts for pre-audit AWS security evidence collection covering IAM, S3, CloudTrail, EC2/VPC, RDS, KMS, and CloudWatch.
